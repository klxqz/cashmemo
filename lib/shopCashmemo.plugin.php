...
class shopCashmemoPlugin extends shopPlugin {
    ...
    public function saveTemplate($data) {
        ...
        file_put_contents(dirname($paths['changed']) . '/css/printform.css', file_get_contents(dirname($paths['original']) . '/css/printform.css'));
        file_put_contents(dirname($paths['changed']) . '/js/printform.js', file_get_contents(dirname($paths['original']) . '/js/printform.js'));
    }
